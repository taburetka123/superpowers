...
- If the output is `true`: You are in **autonomous mode**. Announce: "Running brainstorming in autonomous mode." Follow the `[AUTONOMOUS]` annotations throughout this skill.
...
2. **Offer visual companion** (if topic will involve visual questions) — this is its own message, not combined with a clarifying question. See the Visual Companion section below.
   - [AUTONOMOUS] Skip this step entirely. Visual companion is not used in autonomous mode.
...
[AUTONOMOUS] Skip this gate. The spec self-review (step 7) serves as the quality check. Proceed directly to invoking writing-plans. Log: "Autonomous: skipping user spec review, self-review passed."
